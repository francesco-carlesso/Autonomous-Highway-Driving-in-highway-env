...
model.load_state_dict(torch.load("models/dueling_dqn_model.pth", map_location=device))
model.eval()
...
np.savetxt("data/dueling_dqn_results.csv", np.array(results), delimiter=",", header="Episode,Steps,Return,Crash", comments="")
