...
for t in range(MAX_STEPS):
    ...
    if t % 500 == 0 and t > 0:
        agent.save("models/dueling_dqn_model.pth")

env.close()

np.savetxt("data/dueling_dqn_episode_rewards.csv", np.array(episode_rewards), delimiter=",", header="Episode,Steps,Return", comments="")
