...
model.load_state_dict(torch.load("models/double_dqn_model.pth", map_location=device))
model.eval()
...
np.savetxt("data/double_dqn_results.csv", results, delimiter=",", header="Episode,Steps,Return,Crash", comments='')
