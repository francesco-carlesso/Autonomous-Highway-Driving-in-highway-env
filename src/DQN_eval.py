...
def select_action(state):
    """Returns the best action based on the current state using the loaded DQN model."""
...
np.savetxt("data/dqn_results.csv", results, delimiter=",", header="Episode,Steps,Return,Crash", comments='')
